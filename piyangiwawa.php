...
<table width="70">
    <tr>
        <td>
            <img src="cliff.jpg" id="pic" onmouseover="change1()" onmouseout="change2()">
        </td>
    </tr>
</table>

<h1>石詠澤</h1>
<h2 id="h2text">SHIH YUNG TSE</h2>

<table width="70" border="1">
    <tr>
        <td>
            靜宜資管:
            <a href="https://csim.pu.edu.tw/" target="_blank">
                https://csim.pu.edu.tw/
            </a>
            <br>
            G-Mail: iphone10good@gmail.com
        </td>
